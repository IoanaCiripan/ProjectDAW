    ...
    public partial class CreatedEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MovieStatusId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieStatus", x => x.MovieStatusId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredEmotions = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DownVoteNumber = table.Column<int>(nullable: false),
                    MovieId = table.Column<int>(nullable: false),
                    ProfileId = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieStatusId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieCollection", x => x.MovieCollectionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieCollection_MovieStatusId",
                table: "MovieCollection",
                column: "MovieStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieCollection_ProfileId",
                table: "MovieCollection",
                column: "ProfileId");
